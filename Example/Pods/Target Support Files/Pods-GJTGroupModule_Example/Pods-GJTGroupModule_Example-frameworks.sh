...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GJTGojitoMvvmKit/GJTGojitoMvvmKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GJTGroupModule/GJTGroupModule.framework"
